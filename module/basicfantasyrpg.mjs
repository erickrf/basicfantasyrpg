...
Hooks.once("init", async function () {
  ...
  Actors.registerSheet("basicfantasyrpg", CharacterSheet, {
    types: ["character"],
    makeDefault: true,
    label: "Character Sheet V2",
  });
  Actors.registerSheet("basicfantasyrpg", MonsterSheet, {
    types: ["monster"],
    makeDefault: true,
    label: "Monster Sheet V2",
  });
  Actors.registerSheet("basicfantasyrpg", VehicleSheet, {
    types: ["vehicle"],
    makeDefault: true,
    label: "Vehicle Sheet V2",
  });
  Actors.registerSheet("basicfantasyrpg", SiegeEngineSheet, {
    types: ["siegeEngine"],
    makeDefault: true,
    label: "Siege Engine Sheet V2",
  });
  Actors.registerSheet("basicfantasyrpg", StrongholdSheet, {
    types: ["stronghold"],
    makeDefault: true,
    label: "Stronghold Sheet V2",
  });
...
Handlebars.registerHelper("localizeFloorMaterial", function (type) {
  switch (type) {
    case "roofThatch":
      return game.i18n.localize("BASICFANTASYRPG.RoofThatched");
    case "roofSlate":
      return game.i18n.localize("BASICFANTASYRPG.RoofSlate");
    case "roofWood":
      return game.i18n.localize("BASICFANTASYRPG.RoofWood");
    default:
...
Handlebars.registerHelper("localizeWallMaterial", function (type) {
  switch (type) {
    case "stoneHard":
      return game.i18n.localize("BASICFANTASYRPG.MaterialStoneHard");
    case "stoneSoft":
      return game.i18n.localize("BASICFANTASYRPG.MaterialStoneSoft");
    case "brick":
      return game.i18n.localize("BASICFANTASYRPG.MaterialBrick");
    case "wood":
      return game.i18n.localize("BASICFANTASYRPG.MaterialWood");
    default:
      return game.i18n.localize("ITEM.TypeFloor");
  }
});
...
Handlebars.registerPartial(
  "iconDamage",
  `<i class="fa-solid fa-heart-crack fa-2xl" title="{{localize 'BASICFANTASYRPG.Roll'}} {{localize 'BASICFANTASYRPG.Damage'}}"></i>`
);
...
Handlebars.registerPartial(
  "iconMelee",
  `<i class="fa-solid fa-hand-fist fa-2xl" title="{{localize 'BASICFANTASYRPG.Roll'}} {{localize 'BASICFANTASYRPG.Melee'}} {{localize 'BASICFANTASYRPG.Attack'}}"></i>`
);
...
Handlebars.registerPartial(
  "iconRanged",
  `<i class="fa-solid fa-crosshairs fa-2xl" title="{{localize 'BASICFANTASYRPG.Roll'}} {{localize 'BASICFANTASYRPG.Ranged'}} {{localize 'BASICFANTASYRPG.Attack'}}"></i>`
);
...
Hooks.on("renderDialog", (dialog, html) => {
  ...
  Array.from(html.find("#document-create option")).forEach((i) => {
    if (hiddenTypes.includes(i.value)) i.remove();
  });
});
